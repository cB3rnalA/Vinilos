...
form.addEventListener('submit', e=> {
    ...
    if(!searchValue){
        alert("Ingresa algo en el campo de texto :)")
    }
    else{ 
...
function showData(data){
    ...
    <ul class="song-list">
      ${data.data
        ...
        <a href="Estilos/vin_metal/vin_dreamtheather.html"><button type = "button" class = "btn"; style="background-color: black;">
        Ir a pagina con detalle</button></a>
      </div>
                </li>`
        )
        .join('')}
